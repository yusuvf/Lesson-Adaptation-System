...
export default function Dashboard() {
    ...
    const mainListItems = (
        <div>
            <ListItem button onClick={() => setChooser(0)}>
                <ListItemIcon>
                    <DashboardIcon />
                </ListItemIcon>
                <ListItemText primary="İntibak Başvuruları" />
            </ListItem>
            <ListItem button onClick={() => setChooser(1)}>
                <ListItemIcon>
                    <PeopleIcon />
                </ListItemIcon>
                <ListItemText primary="Akademisyen Düzenleme" />
            </ListItem>
            <ListItem button onClick={() => setChooser(2)}>
                <ListItemIcon>
                    <MenuBookIcon />
                </ListItemIcon>
                <ListItemText primary="Ders Düzenleme" />
            </ListItem>
            <ListItem button onClick={() => setChooser(3)}>
                <ListItemIcon>
                    <BarChartIcon />
                </ListItemIcon>
    ...
    const [chooser, setChooser] = React.useState(0);
